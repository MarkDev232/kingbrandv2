            ...
            <div class="row justify-content-start">
                <div class="col-md-6">
                    <div class="d-flex  mb-3">
                        <button class="btn btn-primary"><a href="admin_user_add.php" class="text-white text-decoration-none"><i class="fa-solid fa-plus"></i> Add Users</a></button>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <table class="table table-sm text-center ">
                            ...
                            if($result){
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    $id = $row['id'];
                                    $first = $row['user_image'];
                                    $two = $row['fullname'];
                                    $three = $row['usename'];
                                    // $nine = $row[''];
                                    echo '<tr>
                                    <td style="padding-top: 16px">'.$id.'</td>
                                    <td><img src="'.$first.'" width="50" height="50" style="border-radius: 25px;"></td>
                                    <td style="padding-top: 16px">'.$two.'</td>
                                    <td style="padding-top: 16px">'.$three.'</td>
                                    <td style="padding-top: 16px">
                                        <button id="btned2"><a href="admin_user_update.php?updateid='.$id.'"><i class="fa-solid fa-user-pen"></i> Update</a></button>
                                        <button id="btnde3"><a href="admin-user-delete.php?deleteid='.$id.'"><i class="fa fa-trash"></i> Delete</a></button>
                                    </td>
                                </tr>';
                                }
                            }
