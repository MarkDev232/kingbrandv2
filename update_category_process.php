...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql2 = "UPDATE product_table SET prod_jersey = '$new_category_name' WHERE prod_jersey = '$old_name'";
    ...
    if ($result && $result2) {
        ...
        echo "<script>window.location.href = 'update_jersey_category.php';</script>";
    } else {
        // Update failed
    ...
    header("Location: update_jersey_category.php");
    exit();
}
?>
