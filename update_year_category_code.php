        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="update_category_process_year.php" method="POST">
                            <div class="mb-3">
                                <label for="category_name" class="form-label">Category Year:</label>
                            ...
                            <a href="update_year_category.php" class="btn btn-secondary">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
