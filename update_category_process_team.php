...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql2 = "UPDATE product_table SET prod_team = '$new_category_name' WHERE prod_team = '$old_name'";
    ...
    if ($result && $result2) {
        ...
        echo "<script>window.location.href = 'update_team_category.php';</script>";
    } else {
        // Update failed
    ...
    header("Location: update_team_category.php");
    exit();
}
?>
