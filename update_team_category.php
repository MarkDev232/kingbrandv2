...
<div class="main-content">
    <section class="container mt-2">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="title">Update Team Category</h2>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM category WHERE cat_type = 'Team'";
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>";
                        // Update button
                        echo "<a href='update_team_category_code.php?category_id={$row['cat_id']}' class='btn btn-primary btn-sm mx-2'>Update</a>";
                        // Delete button
                        echo "</td>";
                        echo "</tr>";
                    }
